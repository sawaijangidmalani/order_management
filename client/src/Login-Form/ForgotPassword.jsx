...
function ForgotPassword() {
  ...
  const sendOtp = async (e) => {
    ...
    try {
      const { data } = await axios.post(
        "https://order-management-pqn2.onrender.com/auth/forgotPassword",
        { email }
      );
  ...
  const verifyOtp = async (e) => {
    ...
    try {
      const { data } = await axios.post(
        "https://order-management-pqn2.onrender.com/auth/verifyOTP",
        { email, otp }
      );
  ...
  const resetPassword = async (e) => {
    ...
    try {
      const { data } = await axios.post(
        "https://order-management-pqn2.onrender.com/auth/resetPassword",
        { email, newPassword }
      );
