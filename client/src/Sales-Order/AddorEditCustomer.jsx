...
const AddorEditCustomer = ({
  ...
  useEffect(() => {
    const fetchProducts = async () => {
      try {
        const res = await axios.get("https://order-management-pqn2.onrender.com/item/getItems");
    ...
    try {
      ...
      if (itemToEdit) {
        response = await axios.put(
          "https://order-management-pqn2.onrender.com/customerpo/editsalesorderitem",
          salesOrderItem
        );
      } else {
        response = await axios.post(
          "https://order-management-pqn2.onrender.com/customerpo/addsalesorderitems",
          salesOrderItem
        );
      }
