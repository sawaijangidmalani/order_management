  ...
  const fetchUtilizationData = async (itemId) => {
    try {
      ...
      const utilResponse = await axios.get(
        `https://order-management-p53a.onrender.com/po/getpurchaseorderitems?itemId=${itemId}`
      );

      const poResponse = await axios.get("https://order-management-p53a.onrender.com/po/getpo");
