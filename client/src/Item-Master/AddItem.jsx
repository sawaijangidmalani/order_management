...
const AddItem = ({ editItem, closeModal }) => {
  ...
  const loadData = async () => {
    try {
      const [supplierRes, unitsRes] = await Promise.all([
        axios.get("https://order-management-pqn2.onrender.com/supplier/getSupplierData"),
        axios.get("https://order-management-pqn2.onrender.com/item/getItemUnits"),
      ]);
  ...
  const handleSubmit = async (e) => {
    ...
    const apiUrl = isEditMode
      ? "https://order-management-pqn2.onrender.com/item/updateItems"
      : "https://order-management-pqn2.onrender.com/item/add_items";
