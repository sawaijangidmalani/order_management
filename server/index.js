...
// // CORS configuration to only allow requests from the Vercel frontend
// const allowedOrigins = ['https://order-management-eosin.vercel.app']; // Your Vercel frontend URL
// app.use(cors({
